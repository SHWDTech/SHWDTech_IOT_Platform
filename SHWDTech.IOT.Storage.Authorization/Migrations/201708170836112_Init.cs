namespace SHWDTech.IOT.Storage.Authorization.Migrations
{
    ...
    public partial class Init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        SHWDIdentityUser_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.SHWDIdentityUser_Id)
                .Index(t => t.SHWDIdentityUser_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Audiences", "SHWDIdentityUser_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Audiences", new[] { "SHWDIdentityUser_Id" });
